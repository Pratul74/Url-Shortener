...
Revision ID: f2503f50be84
Revises: 
Create Date: 2026-07-14 22:47:25.275111
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('accounts_user_user_permissions_permission_id_113bb443'), table_name='accounts_user_user_permissions')
    op.drop_index(op.f('accounts_user_user_permissions_user_id_e4f0a161'), table_name='accounts_user_user_permissions')
    ...
    op.drop_index(op.f('accounts_user_email_b2644a56_like'), table_name='accounts_user', postgresql_ops={'email': 'varchar_pattern_ops'})
    ...
    op.drop_index(op.f('accounts_user_groups_group_id_bd11a704'), table_name='accounts_user_groups')
    op.drop_index(op.f('accounts_user_groups_user_id_52b62117'), table_name='accounts_user_groups')
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['group_id'], ['auth_group.id'], name=op.f('accounts_user_groups_group_id_bd11a704_fk_auth_group_id'), initially='DEFERRED', deferrable=True),
    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'], name=op.f('accounts_user_groups_user_id_52b62117_fk_accounts_user_id'), initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('accounts_user_groups_pkey')),
    sa.UniqueConstraint('user_id', 'group_id', name=op.f('accounts_user_groups_user_id_group_id_59c0b32f_uniq'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('accounts_user_groups_user_id_52b62117'), 'accounts_user_groups', ['user_id'], unique=False)
    op.create_index(op.f('accounts_user_groups_group_id_bd11a704'), 'accounts_user_groups', ['group_id'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('accounts_user_pkey')),
    sa.UniqueConstraint('email', name=op.f('accounts_user_email_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('accounts_user_email_b2644a56_like'), 'accounts_user', ['email'], unique=False, postgresql_ops={'email': 'varchar_pattern_ops'})
    ...
    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'], name=op.f('django_admin_log_user_id_c564eba6_fk_accounts_user_id'), initially='DEFERRED', deferrable=True),
    ...
    sa.Column('user_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('permission_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['permission_id'], ['auth_permission.id'], name=op.f('accounts_user_user_p_permission_id_113bb443_fk_auth_perm'), initially='DEFERRED', deferrable=True),
    sa.ForeignKeyConstraint(['user_id'], ['accounts_user.id'], name=op.f('accounts_user_user_p_user_id_e4f0a161_fk_accounts_'), initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('accounts_user_user_permissions_pkey')),
    sa.UniqueConstraint('user_id', 'permission_id', name=op.f('accounts_user_user_permi_user_id_permission_id_2ab516c2_uniq'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('accounts_user_user_permissions_user_id_e4f0a161'), 'accounts_user_user_permissions', ['user_id'], unique=False)
    op.create_index(op.f('accounts_user_user_permissions_permission_id_113bb443'), 'accounts_user_user_permissions', ['permission_id'], unique=False)
    # ### end Alembic commands ###
